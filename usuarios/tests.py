...
class UsuarioModelTests(TestCase):
    ...
    def test_soft_delete_attributes(self):
        u = Usuario.objects.create(
            username='soft', email='soft@mail.com')
        u.set_password('pwd')
        u.save()
...
class UsuarioAPITests(APITestCase):
    def setUp(self):
        # Desactivamos auth/permisos para estos tests
        self.client.defaults['HTTP_AUTHORIZATION'] = ''

    def test_list_only_active(self):
        Usuario.objects.create(
            username='active', email='active@mail.com')
        Usuario.objects.create(
            username='inactive', email='inactive@mail.com',
            is_active=False)
    ...
    def test_retrieve_user(self):
        user = Usuario.objects.create(
            username='retrieve', email='retrieve@mail.com')
    ...
    def test_partial_update(self):
        user = Usuario.objects.create(
            username='partial', email='partial@mail.com')
        user.set_password('pwd')
        user.save()
    ...
    def test_soft_delete(self):
        user = Usuario.objects.create(
            username='softdel', email='softdel@mail.com')
        user.set_password('pwd')
        user.save()
